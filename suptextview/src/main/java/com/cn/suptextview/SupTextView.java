 ...
 */
public class SupTextView extends RelativeLayout {
    ...
    public SupTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
     ...
     * @return 返回对象
     */
    public SupTextView setLeftIcon(Drawable leftIcon) {
     ...
     * @return 返回对象
     */
    public SupTextView setRightIcon(Drawable rightIcon) {
     ...
     * @return 返回对象
     */
    public SupTextView setLeftString(String leftString) {
     ...
     * @return 返回对象
     */
    public SupTextView setLeftTopString(String leftTopString) {
     ...
     * @return 返回对象
     */
    public SupTextView setLeftBottomString(String leftBottomString) {
     ...
     * @return 返回对象
     */
    public SupTextView setLeftBottomString2(String leftBottomString2) {
     ...
     * @return 返回对象
     */
    public SupTextView setRightString(String rightString) {
     ...
     * @return 返回值
     */
    public SupTextView setCbChecked(boolean checked) {
        isChecked = checked;
     ...
     * @return 返回对象
     */
    public SupTextView setCbBackground(Drawable drawable) {
     ...
     * @return 返回对象
     */
    public SupTextView setLeftTVColor(int textColor) {
     ...
     * @return 返回对象
     */
    public SupTextView setRightTVColor(int textColor) {
     ...
     * @return 返回对象
     */
    public SupTextView setLeftTopTVColor(int textColor) {
     ...
     * @return 返回对象
     */
    public SupTextView setLeftBottomTVColor(int textColor) {
     ...
     * @return 返回对象
     */
    public SupTextView setLeftBottomTVColor2(int textColor) {
